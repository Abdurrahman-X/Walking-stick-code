...
extern const uint8_t sp2_THOUSAND[] PROGMEM = {0x0C,0xE8,0x2E,0xD4,0x02,0x06,0x98,0xD2,0x55,0x03,0x16,0x68,0x7D,0x17,0xE9,0x6E,0xBC,0x65,0x8C,0x45,0x6D,0xA6,0xE9,0x96,0xDD,0xDE,0xF6,0xB6,0xB7,0x5E,0x75,
double speedOfSoundInCmPerMs = 0.03313 + 0.0000606 * temperature; // Cair ˜ (331.3 + 0.606 · ?) m/s
...
UltraSonicDistanceSensor dist1(22, 23);  //TRI,ECO FRONT
UltraSonicDistanceSensor dist2(32, 33 );  //TRI,ECO DOWN
UltraSonicDistanceSensor dist3(17, 18);  //TRI,ECO LEFT
UltraSonicDistanceSensor dist4(14, 16);  //TRI,ECO RIGHT
//WATER  PIN 21
//VIBRATOR  26
//SPEAKER  GND AND 25
...
void loop() {
//////////////////////front////////////////////////////////////////
 d=dist1.measureDistanceCm(27);
   Serial.print("front=");Serial.println(d);
 voice.say(sp4_FRONT);
  sayNumber(d);
  delay(100);
  if(d<tr){
...
voice.say(sp4_FRONT);
voice.say(sp2_DIRECTION);
    delay(500);}
    else digitalWrite(26,LOW);
//////////////////////////////////down//////////////////////////////  
d=dist2.measureDistanceCm(27);Serial.print("down=");Serial.println(d);
  voice.say(sp5_DOWN);
  sayNumber(d);
  if(d>30){digitalWrite(26,HIGH);
    voice.say(sp2_DANGER);
 ...
 ////////////////////////////left/////////////////////////////////////   
    d=dist3.measureDistanceCm(27);Serial.print("left=");Serial.println(d);
  voice.say(sp4_LEFT);
  sayNumber(d);
  delay(100);  
  if(d<tr){digitalWrite(26,HIGH);
voice.say(sp2_DANGER);
voice.say(sp4_LEFT);
voice.say(sp2_DIRECTION);
    delay(500);}
 ...
 ////////////////////////////////right/////////////////////////////////   
 d=dist4 .measureDistanceCm(27);Serial.print("right=");Serial.println(d);
  voice.say(sp4_RIGHT);
  sayNumber(d);
  delay(100);  
  if(d<tr){ digitalWrite(26,HIGH);
...
//  digitalWrite(26,HIGH);
  ...
  voice.say(sp2_DANGER);voice.say(sp2_DANGER);voice.say(sp2_DANGER);
